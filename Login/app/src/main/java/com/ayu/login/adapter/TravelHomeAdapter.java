...
public class TravelHomeAdapter extends RecyclerView.Adapter<TravelHomeAdapter.MyViewHolder>{

    Context context;
    List<TravelHomestay> listTravel;

    public TravelHomeAdapter(Context context, List<TravelHomestay> list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_travel, parent, false);

        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TravelHomeAdapter.MyViewHolder holder, int position) {
