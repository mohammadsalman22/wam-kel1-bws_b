...
public class HomestayHomeAdapter extends RecyclerView.Adapter<HomestayHomeAdapter.MyViewHolder>{

    Context context;
    List<TravelHomestay> listHomestay;

    public HomestayHomeAdapter(Context context, List<TravelHomestay> list) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HomestayHomeAdapter.MyViewHolder holder, int position) {
